...
<!--&lt;!&ndash;			<ul *ngIf="item.items && item.visible !== false" [@children]="submenuAnimation">&ndash;&gt;-->
<!--&lt;!&ndash;				<ng-template ngFor let-child let-i="index" [ngForOf]="item.items">&ndash;&gt;-->
<!--&lt;!&ndash;					<li app-menuitem [item]="child" [index]="i" [parentKey]="key" [class]="child.badgeClass"></li>&ndash;&gt;-->
